...
namespace WebApplication.Models
{
    public class vouchers
    {
        ...
        public vouchers(string makm, string img, string loai, string manhap, string noidung, int daluu, int sl, int phantram, int dieukien, DateTime ngaybd, DateTime ngaykt)
        {
            Makm = makm;
            Img = img;
            Loai = loai;
